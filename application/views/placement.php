<!-- Admissions Layout -->
<div ng-controller="placementController" data-ng-init="init()">
  <div class="aboutvit">
 ...
 <div class="row">
        ...
        <div class="row">
          <div class="col l12">
            <div class="row overview">
              <div>
              <h3 class="vitblue">Placements</h3>
              <p>
  ...
  <div class="col l2 side-link-fixed">
    <div class="row">
      <h3 class=" vitblue">Quick Links</h3>
    </div>

    <div class="row">
      <p class="side-link vitblue">Dream Offers</p>
    </div>
    <div class="row">
      <p class="side-link vitblue">Accredation</p>
    </div>
    <div class="row">
      <p class="side-link vitblue">Community Outreach</p>
    </div>
    <div class="row">
      <p class="side-link vitblue">Infrastructure</p>
    </div>
    <div class="row">
      <p class="side-link vitblue">VIT News</p>
    </div>
    <div class="row">
      <p class="side-link vitblue">Career</p>
    </div>
